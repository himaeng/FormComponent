...
class UserForm extends Component {
  ...
  renderButton() {
    return (
      ...
      >
        <Text style={styles.btnText} accessibilityLabel={'saveButtonText'}>Save</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderTextfield(options) {
    return (
      <TextInput
        accessibilityLabel={options.name}
  ...
  render() {
    return (
      <View style={styles.panel} accessibilityLabel={'contentInnerView'}>
        <Text style={styles.instructions} accessibilityLabel={'placeholder'}>
